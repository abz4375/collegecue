...
const Mentors = () => {
  return (
    <div className="flex  flex-row rounded-[24px] scale-100 overflow-hidden max-w-[1280px] ml-24 mr-24 mx-4 my-20 h-[200px] bg-[#e4e9ff] sm:w-full sm:ml-0 sm:mr-0 sm:h-1/2 hover:scale-95">
      ...
      <div className="w-1/2 flex flex-col justify-center px-10 py-8">
        <p className="text-start text-gray-800 text-lg">new Guidence?</p>
        <h1 className=" text-start text-3xl md:text-2xl text-gray-800 font-bold ">
          Getting Winning Tips From{" "}
          <span className="text-blue-600">Top Mentors !</span>
        </h1>
