...
const SubscribeBox = () => {
  return (
    <>
      ...
      flex flex-row items-center justify-start hover:shadow-xl hover:scale-105 duration-500 transition-all ease-in-out ">
       ...
       <div className='flex flex-col gap-8 m-8 ml-48 md:ml-4'>
        <p className='font-bold text-[30px] md:text-[18px] sm:text-[12px]  '>Subscribe to Our Newsletter</p>
        <div className='flex flex-wrap items-center gap-4'>
          ...
          />
          <button className='W-[120px] h-[44px] bg-[#210366] text-white text-sm flex justify-center items-center p-[8px] rounded-md'>
            SUBSCRIBE
          </button>
        </div>
       </div>
