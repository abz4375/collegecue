...
import banner1 from "../../../../assets/studyAbroad/blogbanner/australia.png";
import banner2 from "../../../../assets/studyAbroad/blogbanner/banner1.png";
import banner3 from "../../../../assets/studyAbroad/blogbanner/canada.png";
import banner4 from "../../../../assets/studyAbroad/blogbanner/hongcong.png";
import banner5 from "../../../../assets/studyAbroad/blogbanner/hongcong.png";
import banner6 from "../../../../assets/studyAbroad/blogbanner/germany.png";
import BlogCard from "@/components/Reusable_cards/studyabroad/BlogCard";
...
const AllBlogCard = () => {
  ...
  return (
    <div className="flex justify-evenly items-start h-auto flex-wrap my-4 mx-0">
        {data.map((item,index)=>(
